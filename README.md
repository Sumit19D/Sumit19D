...
<h2 align="center">🚀 DevOps Enthusiast | AWS + Terraform + CI/CD Automation</h2> <p align="center"> <div style="height:3px;border-width:0;color:gray;background-color:#e5e7eb">
